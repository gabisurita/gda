			...
			if (settings.generateNavigation) { 
				if (settings.navigationFunction) { 
					...
					// insert navigation
                                        ...
                                        $('<div class="multipage_nav" id="'+id_name+'_nav"><a href="#" class="multipage_back" onclick="return  $(\''+id+'\').prevpage();"> Anterior </a><a href="#"  class="multipage_next" onclick="return $(\''+id+'\').nextpage();"> Próxima </a><span class="multipage_state"></span><div class="clearer"></div></div>').insertAfter(this);
				}
			}				
...
$(window).ready(function() {
        $('#multipage').multipage();
	$('form').submit(function(){ alert("Enviado!"); return false;});
});
