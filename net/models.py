...
class AnswerSum(Base):
    ...
    question1 = ('question1', Array(Integer))
    question2 = ('question2', Array(Integer))
    question3 = ('question3', Array(Integer))
    question4 = ('question4', Array(Integer))
    question5 = ('question5', Array(Integer))
    question6 = ('question6', Array(Integer))
    question7 = ('question7', Array(Integer))
    question8 = ('question8', Array(Integer))
    question9 = ('question9', Array(Integer))
    question10 = ('question10', Array(Integer))
    question11 = ('question11', Array(Integer))
    question12 = ('question12', Array(Integer))
    question13 = ('question13', Array(Integer))
